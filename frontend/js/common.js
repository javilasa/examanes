...
const studentApiUrl = () => '/backend/api/student_api.php';
const examApiUrl = () => '/backend/api/exam_api.php';
const questionApiUrl = () => '/backend/api/question_api.php';
const answerApiUrl = () => '/backend/api/answer_api.php';
const configApiUrl = () => '/backend/api/config_api.php';
const groupApiUrl = () => '/backend/api/group_api.php';
const resultsApiUrl = () => '/backend/api/results_api.php';
const publicExamApiUrl = () => '/backend/api/public_exam_api.php';
const incidentApiUrl = () => '/backend/api/exam_incident_api.php';
